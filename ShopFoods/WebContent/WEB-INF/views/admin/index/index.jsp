...
<div class="row">
	<div class="col-md-4 col-sm-4 col-xs-12">
		<div class="x_panel tile fixed_height_320">
			<div class="x_title" >
				<h2 style="margin-left: 130px;">Category</h2>
				<div class="clearfix"></div>
			</div>
			<div class="x_content">
				<a style="border-radius: 5px;" href="#"><image Style="bor"
						width="355px" height="240px" src="${defines.urlAdmin}/a1.jpg" /></a>
			</div>
		</div>
	</div>
	...
	<div class="col-md-4 col-sm-4 col-xs-12">
		<div class="x_panel tile fixed_height_320 overflow_hidden">
			<div class="x_title">
				<h2 style="margin-left: 137px;">Foods</h2>
				<div class="clearfix"></div>
			</div>
			<div class="x_content">
				<a style="border-radius: 5px;" href="#"><image Style="bor"
						width="355px" height="240px" src="${defines.urlAdmin}/a2.jpg" /></a>
			</div>
		</div>
	</div>
	...
	<div class="col-md-4 col-sm-4 col-xs-12">
		<div class="x_panel tile fixed_height_320">
			<div class="x_title">
				<h2 style="margin-left: 140px;">Users</h2>
				<div class="clearfix"></div>
			</div>
			<div class="x_content">
				<a style="border-radius: 5px;" href="#"><image Style="bor"
						width="355px" height="240px" src="${defines.urlAdmin}/a3.jpg" /></a>
			</div>
		</div>
	</div>
...
<div class="row">
	<div class="col-md-4 col-sm-4 col-xs-12">
		<div class="x_panel">
			<div class="x_title">
				<h2>
					Hướng dẫn sử dụng <small>Guitar Store</small>
				</h2>
