...
<form action="${pageContext.request.contextPath }/admin/slide/edit/${slide.s_id}"
	...
	<div class="col-md-10">
		...
		<div class="row">
			<div class="col-md-12 panel-info">
				<div class="">
					<div class="panel-title " style="color: #64738E; border-bottom: 1px solid #5A738E;font-size: 30px;">Sửa Slide</div>
				</div>
