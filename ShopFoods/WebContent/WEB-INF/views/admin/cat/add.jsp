...
<form action="${pageContext.request.contextPath }/admin/cats/add"
			...
			<div class="col-md-12 panel-info">
				<div class="">
					<div class="panel-title "
						style="color: #64738E; border-bottom: 1px solid #5A738E; font-size: 30px; text-align: center;">Thêm
						danh mục</div>
				</div>
							...
							<div class="col-sm-6">
								<div class="form-group">
									<label for="name" style="margin: 10px 0px; color: #4267B2;">Tên
										...
										placeholder="Nhập danh mục tin">
									<form:errors path="cat.cname" style="color:red;"></form:errors>
