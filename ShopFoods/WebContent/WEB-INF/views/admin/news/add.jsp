			...
			<div class="col-md-12 panel-info">
				<div class="">
					<div class="panel-title "
						style="color: #64738E; border-bottom: 1px solid #5A738E; font-size: 30px;">Thêm
						Foods</div>
				</div>
							...
							<c:set var="food" value="${food}"></c:set>
								...
								<div class="form-group">
									<label>Danh mục *</label> <select class="form-control"
										...
										<c:forEach items="${listCats}" var="cat">
											<option <c:if test="${cat.id_cat == food.id_category }">selected="selected"</c:if> value="${cat.id_cat }">${cat.category_name }</option>
										</c:forEach>
									</select>
								</div>
								<div class="form-group">
								...
								<div class="form-group">
									<label>hình ảnh *</label> <input type="file"
										class="btn btn-default" name="hinhanh" id="exampleInputFile1" value="${image}" required>
									<p class="help-block">
