...
<form style=" margin-left:10px; background-color: #EDEDED; border-radius: 8px; padding: 15px 0px;" action="${pageContext.request.contextPath }/account/edit/${user.id_user}"
					...
					<div>
						...
						<div class="row">
							<div class="col-sm-6">
								...
								<div class="form-group">
									<label>avatar</label> 
									<input type="file" class="form-control" name="hinhanh" id="exampleInputFile1">
									<p class="help-block">
