...
<form action="${pageContext.request.contextPath }/admin/magiamgia/add"
	...
	<div class="col-md-10">
		...
		<div class="row">
			<div class="col-md-12 panel-info">
				<div class="">
					<div class="panel-title " style="color: #64738E; border-bottom: 1px solid #5A738E;font-size: 30px;">Thêm Mã Giảm Giá</div>
				</div>
						...
						<div class="row">
							<div class="col-sm-6">
								<div class="form-group">
									...
									<input type="text" class="form-control" name="ma" placeholder="Nhập danh mục tin">
									<form:errors path="giamgia.ma" style="color:red;"></form:errors>
								
								</div>
								<div class="form-group">
									<label for="name" style="margin: 10px 0px;color: #4267B2;">mức giảm (%)</label> 
									<input type="text" class="form-control" name="giam" placeholder="Nhập danh mục tin" required="required">
								</div>
							</div>
