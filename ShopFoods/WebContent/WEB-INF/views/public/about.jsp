		...
		<div class="container">
			<div
				...
				<div class="col-md-7 col-sm-12 text-center ftco-animate">
					...
					<p class="breadcrumbs">
						<span class="mr-2"><a
							href="${pageContext.request.contextPath}/public/index">Home</a></span> <span>About</span>
					</p>
				</div>
...
<section class="ftco-about d-md-flex">
	<div class="one-half img"
		style="background-image: url(${defines.urlPublic}/images/about.jpg);"></div>
		...
		<div class="row align-items-center">
			<div class="col-md-6 pr-md-5">
				<div class="heading-section text-md-right ftco-animate">
					...
					<p>
						<a href="#" class="btn btn-primary btn-outline-primary px-4 py-3">View
							Full Menu</a>
					</p>
				</div>
			</div>
