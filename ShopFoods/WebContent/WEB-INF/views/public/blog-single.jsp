	...
	<div class="container">
		<div class="row">
			<div class="col-md-8 ftco-animate">
				...
				<p>
					<img src="${defines.urlPublic}/images/image_1.jpg" alt=""
						class="img-fluid">
				</p>
				...
				<p>
					<img src="${defines.urlPublic}/images/image_2.jpg" alt=""
						class="img-fluid">
				</p>
				...
				<div class="about-author d-flex">
					<div class="bio align-self-md-center mr-5">
						<img src="${defines.urlPublic}/images/person_2.jpg"
				...
				<div class="pt-5 mt-5">
					...
					<ul class="comment-list">
						<c:forEach items="${listCommnet}" var="comment">
							<li class="comment"><c:choose>
									...
									<c:otherwise>
										<div class="vcard bio">
											<img
												src="${defines.urlPublic}/images/avatar.png"
												alt="Image placeholder">
										</div>
									</c:otherwise>
								</c:choose>
								<div class="comment-body">
									<h3>${comment.name}</h3>
									<div class="meta">${comment.date_comment}</div>
									<p>${comment.message}</p>
									<p>
					...
					<div class="comment-form-wrap pt-5">
						...
						<c:choose>
							<c:when test="${not empty user }">
								<form
									action="${pageContext.request.contextPath}/public/commentLG"
									method="post">
									<div class="vcard bio" style="float: left; margin-right: 20px;">
										<img
											style="width: 50px; border-radius: 50%; -moz-border-radius: 50%; -webkit-border-radius: 50%;"
											src="${pageContext.request.contextPath}/avatar/${user.avatar}"
											alt="Image placeholder">
									</div>
									<div class="form-group" style="float: left;">
										<span style="color: white; font-size: 20px;">${user.fullname}</span>
									</div>
							...
							<c:otherwise>
								<form action="${pageContext.request.contextPath}/public/comment"
									method="post">
									<div class="vcard bio" style="float: left; margin-right: 20px;">
										<img
											style="width: 50px; border-radius: 50%; -moz-border-radius: 50%; -webkit-border-radius: 50%;"
